...
public class GuitarTest {
	...
	public static void main(String[] args) throws SQLException {
		...
		/*GuitarSpec searchSpec = new GuitarSpec(Builder.FENDER, "Stratocastor", 
                Type.ELECTRIC, 6, Wood.ALDER, Wood.ALDER);*/
		GuitarSpec searchSpec = new GuitarSpec(Builder.COLLINGS, "Stratocastor", 
                Type.ACOUSTIC, 12, Wood.BRAZILIAN_ROSEWOOD, Wood.BRAZILIAN_ROSEWOOD);
