...
<head>
    ...
    function submit(){
	    	$.ajax({
		    	...
		    	type:'POST',
				dataType:'json',
				data:{numStrings:$("#numStrings").val(),builder:$("#builder").val(),guitarModel:$("#guitarModel").val(),type:$("#type").val(),backWood:$("#backWood").val(),topWood:$("#topWood").val()},
				success:function(data){
						$("#guitar").empty();
							for(var i=0;i<data.length;i++){
								var g=data[i];
								var html='<tr><td>'+g['serialNumber'] + '</td><td>' + g['price'] + '</td><td>' +g['builder']+ '</td><td>' +g['model']+'</td><td>' +g['type']+'</td><td>' +g['backWood']+'</td><td>' +g['topWood']+'</td></tr>'+g['numStrings']+'</td></tr>';
								$("#guitar").append(html);
							}
				},
	    	})
...
<div class="container ">
	<div class="row">
		<div class="col-xs-6">
			...
			<div class="form-group">
			<label>琴弦</label><input class="form-control" name="numStrings" id="numStrings"/>
			</div>
